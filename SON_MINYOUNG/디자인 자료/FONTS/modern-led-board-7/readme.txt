...
True Type Font: Modern LED Board-7 version 1.0


EULA
-==-
The font Modern LED Board-7 is freeware for home using only.


DESCRIPTION
-=========-
This is original modern font created in style a LED (Light Emitting Diode) matrix 10*8 units. Latin and Cyrillic code pages are supported.

Files in modern_led_board-7.zip:
       	readme.txt     			this file;
        modern_led_board-7.ttf    	regular true type font;
	modern_led_board-7_screen.png	preview image.
